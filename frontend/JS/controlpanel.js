...
document.addEventListener("DOMContentLoaded", () => {
  ...
  addDeviceForm.addEventListener('submit', (e) => {
            ...
            <div class="left-side">
              <div class="card-icon">
                ...
                <div class="card-details">
                  ...
                  <p class="location-model">${location} • ${model}</p>
                  <div class="status-bar">
                    <span class="signal">
                        <img src="assets/icons/dashboard/signal.svg" alt="">
                        Signal
                      </span>
                      <span class="battery">
                        <img src="assets/icons/dashboard/battery.svg" alt="">
                        100%
                      </span>
                      <p class="last-seen">Last seen: 1 hour(s) ago</p>
                    </div>
                  </div>
                </div>
  
                <div class="card-cta">
                  <span class="device-stats">online</span>
                  <button id="viewMoreBtn">View Details</button>
                </div>
    `;
    ...
    deviceCard.querySelector('#viewMoreBtn').addEventListener('click', () => {
      ...
      selectedDeviceModel.textContent = `${location} • ${model}`;
    ...
    addDeviceForm.reset();
    addDeviceFormWrapper.style.display = "none";
    addDeviceWrapper.style.display = "none";
